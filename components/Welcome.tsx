...
const Welcome = () => {
  ...
  return (
    <div className="flex flex-col justify-center justify-items-center">
        ...
        <Image src="/images/vidiac_logo.png" alt="Vidiac Logo" width="300" height="300" className="animate-rotate" />
        </div>
        ...
        <button data-aos="fade-right" aria-label='dashboard-swap' onClick={() => window.open('/dashboard#swap', '_blank')} className="bg-indigo-500 hover:bg-indigo-700 text-white text-xs sm:text-lg font-bold py-2 px-4 mr-3 rounded-xl">
          Buy Vidiac Tokens
        </button>
