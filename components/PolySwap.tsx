...
const PolySwap: React.FC = () => {
  ...
  return (
    <div className="m-2 flex w-full flex-col items-center justify-center sm:w-[500px]">
      ...
      <PolyswapApp
        ...
        defaultSlippage={12}
        defaultPinnedTokens={{
          56: ['0x237FA37Be83955C62d852B16516e6F4407bf3945'],
        }}
        predefinedTokens={[
          {
        ...
        overrides={{
          SwapCardTitle:
            '<div style="display: flex; align-items: center;"><img src="https://www.vidiac.co/images/vidiac_logo.png" style="width: 30px; height: 30px;"><p style="margin: 0; margin-left: 5px; font-size: 28px;">Swap</p></div>',
        }}
      />
    </div>
  );
